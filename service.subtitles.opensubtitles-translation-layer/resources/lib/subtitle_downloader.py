...
class SubtitleDownloader:
    ...
    def __init__(self):
        ...
        self.api_url = __addon__.getSetting("APIURL")
        ...
        log(__name__, f"Using API URL: {self.api_url}")
        ...
        try:
            self.open_subtitles = OpenSubtitlesProvider(self.api_key, self.username, self.password, self.api_url)
